...
class WK_Plugin {
	...
	public static function skip_notices() {
		...
		if ( get_option( 'set_set_woocrack_updater_plugin_dinyalakan' ) != 'set_api_key_status_greget_82631' ) {?>
				...
				<div class="error">
				<p><?php printf( __( 'WooCrack Updater Plugin has not been activated! %sActivated Now%s to enable automatic updates.', 'woocrack-updater-plugin' ), '<a href="' . esc_url( admin_url( 'admin.php?page=settings_page' ) ) . '" class="button-primary">', '</a>' ); ?></p>
				</div>
