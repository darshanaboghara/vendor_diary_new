...
<body class="hold-transition register-page vd-register-one">
    ...
    <div class="card">
      <div class="card-body register-card-body">
        ...
        <form action="" method="post" onsubmit="return submitUserForm();">
          <div class="input-group mb-3 vd-input-wrap">
            <input type="text" class="form-control vd-frminput2" name="brand_name" value="<?php echo set_value('brand_name'); ?>" placeholder="Brand Name">
            <div class="input-group-append vd-icon">
          ...
          <div class="input-group mb-3 vd-input-wrap">
            <input type="email" class="form-control vd-frminput2" name="email" value="<?php echo set_value('email'); ?>" placeholder="Email">
            <div class="input-group-append vd-icon">
              <div class="input-group-text">
          ...
          <div class="input-group mb-3 vd-input-wrap">
            <input type="password" class="form-control vd-frminput2" name="password" placeholder="Password">
            <div class="input-group-append vd-icon">
              <div class="input-group-text">
          ...
          <div class="input-group mb-3 vd-input-wrap">
            <input type="password" class="form-control vd-frminput2" name="cpassword" placeholder="Confirm Password">
            <div class="input-group-append vd-icon">
              <div class="input-group-text">
                <i class="fas fa-key"></i></span>
              </div>
          ...
          <div class="input-group mb-3 vd-input-wrap">
            <input type="text" class="form-control vd-frminput2" name="mobile_number" value="<?php echo set_value('mobile_number'); ?>" placeholder="Mobile Number">
            <div class="input-group-append vd-icon">
              <div class="input-group-text">
          ...
          <div class="input-group mb-3 vd-input-wrap">
            <input type="text" class="form-control vd-frminput2" name="maplink" id="search_input" value="<?php echo set_value('maplink'); ?>" placeholder="Map Address">
          ...
          <div class="row">
            ...
            <!-- /.col -->
            <div class="col-4">
              <button type="submit" class="btn btn-primary btn-block vd-frmbtn">Register</button>
            </div>
            <!-- /.col -->
          </div>
        </form>
        ...
        <a href="<?php echo base_url(); ?>login" class="text-center dc-link2">I already have a membership</a>
      </div>
      <!-- /.form-box -->
    </div><!-- /.card -->
  </div>
