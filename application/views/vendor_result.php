...
<div class="vd-vendor-category-page">
	<div class="page-header">
		<div class="container">
			<div class="row">
				<!-- page caption -->
				<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
					<div class="vd-search-two">
	...
	<div class="page-resultstrip vd-resultstrip">
		<div class="container">
			<div class="row">
				<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
		...
		<div class="container nopadding">
			<div class="row">
				<div id="filter-result" class="col-xl-3 col-lg-3 col-md-4 col-sm-12 col-12">
					<div class="mf-heading">
						<div class="mf-inside">
							...
							<div class="reset" id="filtercross">
								<svg viewBox="0 0 24 24" style="display: inline-block; color: rgba(0, 0, 0, 0.87); fill: rgb(255, 255, 255); height: 24px; width: 24px; user-select: none; transition: all 450ms cubic-bezier(0.23, 1, 0.32, 1) 0ms;">
					...
					<!--    </form>-->
					<!--</div>-->
					<div class="filter-form vd-filter">
				...
				<div class="col-xl-9 col-lg-9 col-md-8 col-sm-12 col-12 vd-right-list" id="data">
					<div class="vd-inner-list">
						<!--Google Ads-->
						...
						?>
								...
								<div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 float-left slideExpandUp">
									...
									<div class="vendor-thumbnail vd-item-block" id="product">
                                        ...
                                        -->
												<?php $r = rand(1, 40); ?>
												<img loading="lazy" src='<?php echo (file_exists(IMAGELINK . $data->image)) ? base_url() . IMAGELINK . $data->image : base_url() . "assets/images/wedding-planner/$r.jpeg"; ?>' alt="Vendor Image Not Found" class="img-fluid">
											</a>
											<!-- demo.jpg -->
										</div>
											...
											<div class="vendor-line">
												<div class="vendor-detail1">
													...
													<h2 itemprop="name" class="vendor-title ellipsis">
														...
														?>
															<img loading="lazy" src="https://akam.cdn.jdmagicbox.com/images/icontent/newwap/newprot/jdvrsl_verified.svg" style="-webkit-user-drag: none;">
														<?php }
														?>
												...
												?>
													<div class="d-flex flex-column vd-sec2">
														...
														<div>
															<span class="blurry-text" onclick="alert('You need to login first')"><?php echo (substr($data->mobile, 0, 2) . 'XXXXXXXX'); ?></span>
														</div>
													</div>
												<?php } ?>
											</div>
										...
										<div class="vendor-line pricing-enq">
											<div class="vendor-btn vendor-detail1">
												<a href="#EnquiryPopUp" style="color:<?php echo $site->colour_name; ?>;" onclick="EnquiryPopUp('<?php echo $data->id ?>','vender-listing','<?php echo $data->planner_name ?>');" class="vd-enquiry"><i class="fa fa-envelope"></i> Send Enquiry</a>
												<div class="social" style="float:right;color:<?= $site->colour_name; ?>;">
													<a href="<?= $data->facebook_link ?>" style="color:<?php echo $site->colour_name; ?>;"><i class="fab fa-facebook-f"></i></a>
													<a href="<?= $data->twitter_link ?>" style="color:<?php echo $site->colour_name; ?>;"><i class="fab fa-twitter"></i></a>
													<a href="<?= $data->google_link ?>" style="color:<?php echo $site->colour_name; ?>;"><i class="fab fa-google"></i></a>
													<a href="<?= $data->linkedin_link ?>" style="color:<?php echo $site->colour_name; ?>;"><i class="fab fa-linkedin-in"></i></a>
													<a href="whatsapp://send?text=https://vendordiary.com/Vendor_details?vid=<?= $data->id; ?>" style="color:<?php echo $site->colour_name; ?>;" data-action="share/whatsapp/share"><i class="fab fa-whatsapp"></i></a>
												</div>
											</div>
										</div>
					...
					<div class="row vd-pagination" id="page">
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
				...
				<div class="row">
					...
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
						...
						<div class="form-group">
							...
							<input id="full_name" required type="text" name="full_name" placeholder="Name" class="form-control" value="<?php if ($this->session->googlelogin == TRUE) {
					...
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
						...
						<div class="form-group service-form-group">
							...
							<input id="email_id" required name="email_id" type="email" placeholder="Email Address" class="form-control" value="<?php if ($this->session->googlelogin == TRUE) {
					...
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
						...
						<div class="form-group service-form-group">
							...
							<input id="mobile_number" required type="tel" name="mobile_number" placeholder="Mobile Nummber" class="form-control" value="" maxlength="10" data-valid="required" />
						</div>
					</div>
					...
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
						...
						<div class="form-group service-form-group">
							...
							<textarea id="comment" required type="tel" name="comment" placeholder="Comment" class="form-control" value="" data-valid="required"></textarea>
					...
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mt-3 ">
						<input type="submit" name="singlebutton" class="btn btn-default btn-sm" name="Send" value="Send" id="SendEnquiry">
					</div>
				</div>
			</form>
			<form name="quote_form_otp" id="quote_form-otp" class="quote_form-otp" style="display:none;">
				<div class="row">
					<div id="quote-form-otp">
						...
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mt-3 ">
							<div class="form-group">
								<button type="submit" name="singlebutton" id="verify_otp" class="btn btn-default btn-sm" onclick="Mobile.Otp(event);">Submit
								</button>
							</div>
						</div>
					</div>
