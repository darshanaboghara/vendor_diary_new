<section id="controller" class="logo-container vd-plan-cms">
  <div class="vd-section-title">
    <h2 class="vd-title2">Vendor Plans</h2>
  </div>
  <div class="row center vd-plan-content">
    <ul>
      <li>
  ...
  <div class="row">
    <div class="col">
      <a href="<?= base_url() ?>Vendorplan" class="btn vd-btn1">Show More Plan Details</a>
    </div>
  </div>
</section>
