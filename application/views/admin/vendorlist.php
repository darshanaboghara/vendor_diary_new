            ...
            <div class="card">
              <div class="card-header">
                ...
                <h3 class="card-title" style="float: right;">
                    <button type="button" class="btn btn-block btn-primary" data-toggle="modal" data-target="#exampleModal">Add New Vendor</button>
                </h3>
                <br>
                
                    <form method="POST" action="<?php echo base_url();?>Admin/vendorlistbyfilter">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-3">
                  ...
                  <tbody>
                      <?php
                        foreach($allvendor as $data)
                        {
                            ?>
                            <tr>
                                <td><a href="<?php echo  base_url();?>Admin/vendorquerybyid?id=<?= $data->id ?>"><?php echo $data->id;?></a></td>
                               ...
                               <td><?php echo $data->plan_status;?></td>
                                ...
                                <td>
                                 ...
                                 <td>
                                    <?php if($data->ip_address)
                                    { ?>
                                    <a class="btn btn-block btn-primary" target='_blank' href="https://whatismyipaddress.com/ip/<?php echo $data->ip_address?>">Location</a>
                                    <? }?>
                                </td>
 ...
 <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form  method="POST" action="<?php echo base_url(); ?>Admin/addVendorByAdmin">
        <div class="modal-body">
            ...
            <div class="input-group mb-3">
             ...
             <div class="input-group mb-3">
              <input type="text" class="form-control" name="password" value="<?php echo set_value('password'); ?>" placeholder="Password" required>
              <div class="input-group-append">
                <div class="input-group-text">
...
<script>
    ...
    function updatevendor($vid,$status) {
         ...
         if(confirm("Do u want to continue?")) 
         {
            ...
            xhttp.open("GET", "<?php echo base_url(); ?>Admin/updatevendor?vid=" + $vid+"&status="+$status, true);
            xhttp.send();
