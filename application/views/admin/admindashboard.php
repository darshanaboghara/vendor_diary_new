  ...
  <div class="content-wrapper">
    ...
    <?php } ?>
      <div class="container-fluid">
        ...
        <h2 class="m-3">Coustomer Count</h2>
        <div class="row">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                <h3><?php echo $this->OH->gettodaycustomerscount() ?></h3>
              ...
              <a href="<?php echo base_url()?>Admin/cutomerlist" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                <!--<h3>53<sup style="font-size: 20px">%</sup></h3>-->
                <h3><?php  echo $this->OH->getlastweekcustomerscount();   ?></h3>

                <p>Last Week Customer(s)</p>
              </div>
              <div class="icon">
                <i class="fas fa-users"></i>
              </div>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
                <h3><?php  echo $this->OH->getLastMonthcustomersCount();   ?></h3>

                <p>Last Month Customer(s)</p>
              </div>
              <div class="icon">
                <i class="fas fa-users"></i>
              </div>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              <div class="inner">
                <h3><?php echo count($this->OH->getallcustomers());?></h3>
