          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title" style="display: inline;">vendor Details List
                <?php echo "<div style='color:green'>". $this->session->flashdata('Success')."</div>";?>
                </h3>
                <h3 class="card-title" style="float: right;">
                    <a href="<?php echo base_url();?>Admin/expiredplanreminderbyadmin" class="btn btn-block btn-primary">Reminder All Vendor</a>
                </h3>
                      ...
                      <?php
                        foreach($allvendor as $data)
                        {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a  class="btn btn-primary" href="<?php echo base_url(); ?>Admin/expiredplanreminder?email=<?php echo $data->email;?>">Reminder</a>
                                </td>
