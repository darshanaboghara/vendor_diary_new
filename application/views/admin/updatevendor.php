                    ...
                    <form id="quickForm" method="POST" action="<?php echo base_url();?>Admin/updateVendorServicebyAdmin">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="package" class="form-control" id="package" value="<?php echo $vdata->package;?>" placeholder="package">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="start_rate_range" class="form-control" id="start_rate_range" value="<?php echo $vdata->start_rate_range;?>" placeholder="start_rate_range">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" name="end_rate_range" class="form-control" id="end_rate_range" value="<?php echo $vdata->end_rate_range;?>" placeholder="end_rate_range">
                                    <div class="input-group-append">
                                        <span class="input-group-text">.00</span>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="capacity" class="form-control" id="capacity" value="<?php echo $vdata->capacity;?>" placeholder="capacity">
                            </div>
                    ...
                    <div class="row">
                      <div class="col-sm-3">
                        <a  data-toggle="lightbox" data-title="sample 1 - white" data-gallery="gallery">
                          <img src="<?php echo (file_exists(IMAGELINK. $vdata->image))? base_url().IMAGELINK. $vdata->image : base_url().'assets/images/wedding-planner/demo.jpg';  ?>" class="img-fluid mb-2" alt="white sample"/>
                        </a>
                            <form action="https://vendordiary.com/Admin/vendorimageupload/" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                                <input type='text' name='image' value='image' hidden>
                                <input type='text' name='vid' value='<?php echo $vdata->id;?>' hidden>
                      ...
                      <div class="col-sm-3">
                        <a  data-toggle="lightbox" data-title="sample 1 - white" data-gallery="gallery">
                          <img src="<?php echo (file_exists(IMAGELINK. $vdata->image_2))? base_url().IMAGELINK. $vdata->image_2 : base_url().'assets/images/wedding-planner/demo.jpg';  ?>" class="img-fluid mb-2" alt="white sample"/>
                        </a>
                        <form action="https://vendordiary.com/Admin/vendorimageupload/" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                                <input type='text' name='image' value='image_2' hidden>
                                <input type='text' name='vid' value='<?php echo $vdata->id;?>' hidden>
                                <input type='file' class='form-control' name='image_2' size='20' />
                                <input class='btn btn-primary' type='submit' name='submit' value='upload' /> 
                            </form>
                      </div>
                      <div class="col-sm-2">
                        <a  data-toggle="lightbox" data-title="sample 1 - white" data-gallery="gallery">
                           <img src="<?php echo (file_exists(IMAGELINK. $vdata->image_3))? base_url().IMAGELINK. $vdata->image_3 : base_url().'assets/images/wedding-planner/demo.jpg';  ?>" class="img-fluid mb-2" alt="white sample"/>
                        </a>
                         <form action="https://vendordiary.com/Admin/vendorimageupload/" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                                <input type='text' name='image' value='image_3' hidden>
                                <input type='text' name='vid' value='<?php echo $vdata->id;?>' hidden>
                                <input type='file' class='form-control' name='image_3' size='20' />
                                <input class='btn btn-primary' type='submit' name='submit' value='upload' /> 
                            </form>
                      </div>
                      <div class="col-sm-2">
                        <a  data-toggle="lightbox" data-title="sample 1 - white" data-gallery="gallery">
                           <img src="<?php echo (file_exists(IMAGELINK. $vdata->image_4))? base_url().IMAGELINK. $vdata->image_4 : base_url().'assets/images/wedding-planner/demo.jpg';  ?>" class="img-fluid mb-2" alt="white sample"/>
                        </a>
                        <form action="https://vendordiary.com/Admin/vendorimageupload/" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                                <input type='text' name='image' value='image_4' hidden>
                                <input type='text' name='vid' value='<?php echo $vdata->id;?>' hidden>
                                <input type='file' class='form-control' name='image_4' size='20' />
                                <input class='btn btn-primary' type='submit' name='submit' value='upload' /> 
                            </form>
                      </div>
                      <div class="col-sm-2">
                        
                          <img src="<?php echo (file_exists(IMAGELINK. $vdata->image_5))? base_url().IMAGELINK. $vdata->image_5 : base_url().'assets/images/wedding-planner/demo.jpg';  ?>" class="img-fluid mb-2" alt="white sample"/>
                            <form action="https://vendordiary.com/Admin/vendorimageupload/" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                                <input type='text' name='image' value='image_5' hidden>
                                <input type='text' name='vid' value='<?php echo $vdata->id;?>' hidden>
                                <input type='file' class='form-control' name='image_5' size='20' />
                                <input class='btn btn-primary' type='submit' name='submit' value='upload' /> 
                            </form>
                      </div>
                </div> 
