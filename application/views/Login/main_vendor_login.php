...
<head>
	...
	<meta name="google-signin-client_id"
		  content="797061690576-9l8anl03tvgj7vi02a8jreav8tr6f3t6.apps.googleusercontent.com">
	<script>
...
<section class="main_login"
	...
	<div class="w-100 text-center" id="vendor-login">
		<div class="mb-5">
			...
			<p class="text-white">Expand your service business with
				<span>"<?php echo $site->web_frienly_name; ?>"</span>
						...
						<div class="mb-3 bg-transparent position-relative input_wrapper">
							<div class="position-relative reg_input_wrapper mb-4">
								...
								<input id="email" type="email" name="email" placeholder="Email" class="form-control"
									   data-valid="required" tabIndex="1" autofocus autocomplete="off">
								<div id="error"></div>
							</div>
							<div class="position-relative reg_input_wrapper mb-4">
								<i class="bi bi-key-fill outline-0"></i>
								<input id="newpassword" type="password" name="password" placeholder="Password"
									   class="form-control" data-valid="required" tabIndex="1" autofocus
									   autocomplete="off">
					...
					<div class="col-xl-12">
						...
						<div class="w-100 text-center">
							...
							>
								...
								Register as Vendor Signup Now
							</a>
						</div>
					</div>
				</div>
			</form>
			<form name="otpform" id="otpform" style="display: none;" action="#">
				<div class="row">
					<div class="col-xl-12 col-sm-12">
						...
						<div class="mb-3 bg-transparent position-relative input_wrapper">
							<div class="position-relative reg_input_wrapper mb-4">
								<i class="bi bi-envelope-fill outline-0"></i>
								<input id="otp" type="number" minlength=6 maxlength=6 name="opt" placeholder="Enter otp"
									   required class="form-control" data-valid="required" autocomplete="off">
								<div id="error1"></div>
							</div>
							<div class="position-relative reg_input_wrapper mb-4">
								<i class="bi bi-key-fill outline-0"></i>
								<button type="button" onclick="sendotp();" tabIndex="10" name="loginbutton" name="LOGIN"
										value="LOGIN" id="loginbutton"
										class="btn btn-primary shadow-none border-0 text-capitalize reg_btn">OTP
								</button>
								<div id="error1"></div>
							</div>
						</div>
					...
					<div class="col-xl-12">
						<div class="d-flex align-items-center justify-content-between">
							<p class="mt-2">
								<a href="javascript:void(0);" onclick="Home.ForgotPassword(event);"
								   class="wizard-form-small-text"> Forgot your password?
								</a>
							</p>
							<button type="button" onclick="validotp();" name="loginbutton" name="OTP" value="OTP"
									id="loginbutton" class="btn btn-primary shadow-none border-0 text-capitalize reg_btn">
								Validate OTP & Login
							</button>
						</div>
					</div>
