...
?>
	...
	<div class="fadeIn vd-vendor-detail-page vd-main" id="object">
		<div class="vd-main-inner">
			<div class="container">
				<div class="row">
					<div class="col-xl-8 col-lg-8 col-md-7 col-sm-12 col-12">
						<!--vendor-details -->
						<div class="v-img_shadowbox vd-section-one">
							...
							<div class="vendor-infobox vd-info">
								<div class="vendorheading">
									<div class="vcontent">
										<h2 class="h1 vd-title" style="color:black;"><?php echo $vdata[0]->business_name; ?></h2>
										<p class="vd-subtitle">
											<i class="fa fa-map-marker-alt"></i>
											<span><?php echo $vdata[0]->address; ?></span>
										</p>
									</div>
									<div class="vendor-gllry text-left">
										...
										<!--</a>-->
										<a href="#EnquiryPopUp" style="color:<?php echo $site->colour_name; ?>" onclick="EnquiryPopUp('<?php echo  $vdata[0]->id;  ?>','vendor-details','<?php echo $vdata[0]->planner_name; ?>');" class="vd-btn2 shake-little vd-enquirybtn" id="app-emp-phone-txt">
										...
										if ($vdata[0]->RegisterBy == "ADMIN") {
											if ($vdata[0]->business_claim == "No") { ?>
												<a href="#ClaimBusiness" style="color:<?php echo $site->colour_name; ?>" onclick="ClaimPopUp('<?php echo  $vdata[0]->id;  ?>','vendor-details','<?php echo $vdata[0]->planner_name; ?>');" class="vd-btn2 vd-claimbtn" id="Cliam ">claim this business</a>
										<?php }
										}
										?>
						...
						<div class="">
							<div class="card border card-shadow-none vd-section-two vd-cardblock">
								<h3 class="card-header bg-white vd-title">About <?php echo $vdata[0]->business_name; ?> </h3>
								<div class="card-body">
									<!--/.vendor-details -->
									<!--vendor-description -->


									<p class="vd-desc"> <?php echo $vdata[0]->description; ?></p>
								</div>
							</div>
							<!--vendor-description -->
							<div class="card border card-shadow-none vd-section-three vd-cardblock">
								<h3 class="card-header bg-white vd-title">Vendor Detail</h3>
							...
							<?php } ?>
							<!--Vendor Time-->
							<div class="card border card-shadow-none vd-section-four vd-cardblock">
								<h3 class="card-header bg-white vd-title">Time </h3>
								<div class="card-body">
									<div class="row">
							...
							<!--Vendor Review-->
							<div class="card border card-shadow-none vd-section-five vd-cardblock">
								<h3 class="card-header bg-white vd-title">Vendor Review </h3>
								<div class="card-body ex1 vd-detail">
									<!--/.vendor-details -->
									<!--vendor-description -->
									<?php
									if (!$vreviews) {
							...
							<?php if ($vdata[0]->plan_status != "Paid") {
							?>
								<div class="card border card-shadow-none vd-section-six vd-cardblock">
									<h3 class="card-header bg-white vd-title">Recommendation</h3>
									<div class="card-body">
							...
							<amp-ad width="100vw" height="320" type="adsense" data-ad-client="ca-pub-8898782763527089" data-ad-slot="7583292577" data-auto-format="mcrspv" data-full-width="">
								<div overflow=""></div>
							</amp-ad>
						</div>
						<!-- /.review-content -->
								...
								<div class="card-body">
									<form method="POST" action="<?php echo base_url(); ?>Venorenquiry" name="sendRequest" id="sendRequest">
										<div class="row dc-row">
											<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
												<h3 class="dc-title">Request Quote</h3>
											</div>
											...
											<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
												<div class="form-group">
													...
													<input id="en_name" name="full_name" required type="text" placeholder="Name" class="form-control input-md vd-frminput" value="<?php if ($this->session->googlelogin == TRUE) {
											...
											<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
												<div class="form-group">
													...
													<input id="en_email" name="email_id" type="email" required placeholder="Email Address" value="<?php if ($this->session->googlelogin == TRUE) {
																																						echo $this->session->googleemail;
																																					} ?>" class="form-control input-md vd-frminput" data-valid="required" />
												</div>
											</div>
											<!-- Text input-->
											<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
												<div class="form-group">
													...
													<input id="en_mobile" name="mobile_number" required type="tel" placeholder="Mobile Nummber" pattern="[0-9]{10}" class="form-control input-md vd-frminput" maxlength="10" data-valid="required" />
											...
											<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
												<div class="form-group">
													...
													<textarea class="form-control vd-frmtextarea" id="comment" name="comment" rows="3" placeholder="Write Comment" maxlength="500" data-valid="required"></textarea>
												</div>
											</div>
											<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
												<div class="form-group">
													<input type="submit" name="Submit" value="Submit" style="background:<?php echo $site->colour_name; ?>; color:<?php echo $site->font_color; ?>;border-color:<?php echo $site->colour_name; ?>;" class="btn btn-primary btn-block vd-frmbtn" id="SendRequest">
												</div>
											</div>
										</div>
									</form>
					...
					<div class="row">
						...
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
							...
							<div class="form-group">
								...
								<input id="full_name" type="text" name="full_name" placeholder="Name" class="form-control" value="<?php if ($this->session->googlelogin == TRUE) {
																																		echo $this->session->googlename;
						...
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
							...
							<div class="form-group service-form-group">
								...
								<input id="email_id" name="email_id" type="email" placeholder="Email Address" class="form-control" value="<?php if ($this->session->googlelogin == TRUE) {
																																				echo $this->session->googleemail;
																																			} ?>" required data-valid="required" />
							</div>
						</div>
					...
					<div class="row">
						...
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
							...
							<div class="form-group">
								...
								<input id="full_name" type="text" name="full_name" placeholder="Your Name" class="form-control" value="<?php if ($this->session->googlelogin == TRUE) {
																																			echo $this->session->googlename;
																																		} ?>" required data-valid="required">
							</div>
						</div>
