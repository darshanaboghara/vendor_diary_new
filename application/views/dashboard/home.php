        ...
        <div class="row">
            <div class="col-xl-12 col-lg-10 col-md-9 col-sm-12 col-12">
                <div class="dashboard-page-header">
                    ...
                    <h3 class="dashboard-page-title">Hi, <?php echo $vdata->last_name;?></h3>
        ...
        <div class="row">
            ...
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                <div class="card card-summary">
                    ...
                    <div class="card-footer text-center"><a href="<?php echo base_url();?>Dashboard/Enquires_List?status=OLD">View All</a></div>
                </div>
            </div>
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
                <div class="card card-summary">
                    ...
                    <div class="card-footer text-center"><a href="<?php echo base_url();?>Dashboard/Enquires_List?status=NEW">View All</a></div>
