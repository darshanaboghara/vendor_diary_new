                                ...
                                foreach($allstaff as $data)
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                         ...
                                         <td>
                                            <button type="button" class="btn btn-block btn-primary" data-toggle="modal" data-target="#UpdateModal" onclick="StaffUpdatePopUp('<?php echo $data->id?>','<?php echo $data->username?>','<?php echo $data->email?>','<?php echo $data->mobile?>','<?php echo $data->password?>','<?php echo $data->role?>','<?php echo $data->status?>')">Update</button>
                                        </td>
                                         <td>
                                            <button type="button" class="btn btn-block btn-danger" onclick="deleteStaff('<?php echo $data->id?>')">Delete</button>
                                        </td>
