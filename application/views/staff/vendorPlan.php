                ...
                <table class="table table-bordered table-responsive table-striped">
                  <thead>
                    <tr>
                      ...
                      <th>Plan Duration</th>
                      <th>Customer Lead</th>
                      <!--<th>Vendor Listing Service Providers</th>-->
                      <th>Status</th>
                      ...
                      <?php
                        foreach($vplan as $data)
                        {
                            ...
                            <tr id="rowid<?php echo $data->id;?>">
                                ...
                                <td><a  class="btn btn-danger swalDefaultWarning" onclick='deleteplan("<?php echo $data->id;?>")'>Delete</a></td>
                            </tr>
                            <?php
                        }
                      ?>
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form  method="POST" action="<?php echo base_url(); ?>Admin/vendorPlanUpdate">
...
<div class="modal fade" id="AddModal" tabindex="-1" role="dialog" aria-labelledby="AddModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form  method="POST" action="<?php echo base_url(); ?>Admin/addNewPlan">
        <div class="modal-body">
