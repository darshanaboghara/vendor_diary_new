  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>New Vendor Details</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">New Vendor Details</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                      ...
                      <?php
                        foreach($allvendor as $data)
                        {
                            ...
                            <tr>
                                ...
                                <td>
                                     <a  class="btn btn-primary" data-toggle="modal" data-target="#exampleModal"  onclick='EnquiryPopUp("<?php echo $data->id;?>","<?php echo $data->email;?>")'>Paid</a>
                                </td>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <input type="text" name="id" class="form-control" id="recipient-id"  hidden>
           ...
           <div class="form-group">
                <label for="email" class="col-form-label" id="recipient-email">New Email</label>
