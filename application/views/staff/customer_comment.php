                      ...
                      <?php
                        foreach($customer_comment as $data)
                        {
                            ...
                            <tr>
                                ...
                                <td><a  class="btn btn-primary" data-toggle="modal" data-target="#exampleModal"  onclick='EnquiryPopUp("<?php echo $data->id;?>","<?php echo $data->email;?>")'>Open modal for <?php echo $data->email;?></a></td>
                            </tr>
                            <?php
                        }
                      ?>
