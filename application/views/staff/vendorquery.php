                      ...
                      <?php
                        foreach($vquery as $vendor)
                        {
                            ...
                            <tr>
                                ...
                                <td><a  class="btn btn-primary" data-toggle="modal" data-target="#exampleModal"  onclick='EnquiryPopUp("<?php echo $vendor->id;?>","<?php echo $vendor->email;?>")'>Open modal for <?php echo $vendor->email;?></a></td>
