              ...
              <div class="card-body">
                <div class="tab-content" id="custom-tabs-five-tabContent">
                  ...
                  <div class="tab-pane fade" id="custom-tabs-five-overlay-dark" role="tabpanel" aria-labelledby="custom-tabs-five-overlay-dark-tab">
                    ...
                    <form id="quickForm" method="POST" action="<?php echo base_url();?>Staff/updateVendorLinkbyStaff">
                        <div class="card-body">
                            <input name="id" value="<?php echo $vdata->id;?>" hidden>
                            <div class="form-group">
                  ...
                  <div class="tab-pane fade" id="custom-tabs-five-normal-2" role="tabpanel" aria-labelledby="custom-tabs-five-normal-tab-2">
                    <p><?php if($this->session->flashdata('message_name'))
                    {
                    ...
                    <div class="row">
                      <div class="col-sm-2">
                        ...
                        <div class="desc">
                            ...
                            <?php echo form_open_multipart('Staff/image/'); ?>
                            <?php echo "<input type='file' class='form-control' name='image' size='20' />"; ?>
                            <?php echo "<input type='text' name='userid' value='$vdata->id' hidden/>"; ?>
                            <?php echo "<input type='text' name='fild' value='image' hidden/>"; ?>
                      ...
                      <div class="col-sm-2">
                        ...
                        <div class="desc">
                            ...
                            <?php echo "<input type='file' class='form-control' name='image' size='20' />"; ?>
                            <?php echo "<input type='text' name='userid' value='$vdata->id' hidden/>"; ?>
                            <?php echo "<input type='text' name='fild' value='image_2' hidden/>"; ?>
                            <?php echo "<input class='btn btn-primary' type='submit' name='submit' value='upload' /> "; ?>
                            <?php echo "</form>" ?>
                        </div>
                      </div>
                      <div class="col-sm-2">
                        ...
                        <div class="desc">
                            ...
                            <?php echo "<input type='file' class='form-control' name='image' size='20' />"; ?>
                            <?php echo "<input type='text' name='userid' value='$vdata->id' hidden/>"; ?>
                            <?php echo "<input type='text' name='fild' value='image_3' hidden/>"; ?>
                            <?php echo "<input class='btn btn-primary' type='submit' name='submit' value='upload' /> "; ?>
                            <?php echo "</form>" ?>
                        </div>
                      </div>
                      <div class="col-sm-2">
                        ...
                        <div class="desc">
                            ...
                            <?php echo "<input type='file' class='form-control' name='image' size='20' />"; ?>
                            <?php echo "<input type='text' name='userid' value='$vdata->id' hidden/>"; ?>
                            <?php echo "<input type='text' name='fild' value='image_4' hidden/>"; ?>
                            <?php echo "<input class='btn btn-primary' type='submit' name='submit' value='upload' /> "; ?>
                            <?php echo "</form>" ?>
                        </div>
                      </div>
                      <div class="col-sm-2">
                         ...
                         <div class="desc">
                            ...
                            <?php echo "<input type='file' class='form-control' name='image' size='20' />"; ?>
                            <?php echo "<input type='text' name='userid' value='$vdata->id' hidden/>"; ?>
                            <?php echo "<input type='text' name='fild' value='image_5' hidden/>"; ?>
                            <?php echo "<input class='btn btn-primary' type='submit' name='submit' value='upload' /> "; ?>
                            <?php echo "</form>" ?>
                        </div>
                      </div>
