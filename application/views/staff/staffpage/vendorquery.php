 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
          <div class="row">
            <form method="POST" action="<?php echo base_url();?>staff/vendorquerybyfilter">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-4">
                                ...
                                <div class="col-2"><a href="<?php echo base_url()?>staff/vendorquery" class="btn btn-block btn-primary" >Clear Filter</a></div>
                            </div>
                        </div>
                      ...
                      <?php
                        foreach($vquery as $vendor)
                        {
                            ...
                            <tr>
                                ...
                                <td><a  class="btn btn-primary" data-toggle="modal" data-target="#exampleModal"  onclick='EnquiryPopUp("<?php echo $vendor->id;?>","<?php echo $vendor->email;?>")'>Send Response</a></td>
                                <td><?php  if($vendor->status=="SEND")
                                            {
...
<div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form  method="POST" action="<?php echo base_url(); ?>Staff/vendorQueryStaffResponse">
