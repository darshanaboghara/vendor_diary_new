jQuery(document).ready(function($) {
    ...
    if ($('.header-transparent').length) {
        ...
        $(window).scroll(function() {
            if ($(".header-transparent").offset().top > 100) {
    ...
    if ($("#weddingdate, #taskdate").length) {
        ...
        $("#weddingdate, #taskdate").datepicker({ minDate: "-1Y -3M", maxDate: "0",dateFormat: 'dd-mm-yy',onSelect: function (selected) {
            var dt = new Date(selected);
            dt.setDate(dt.getDate() + 1);
            $("#weddingenddate").datepicker("option", "minDate", dt);
        }});
        $('#ui-datepicker-div').before('<div class="default-skin"></div>');
        $('#ui-datepicker-div').appendTo('.default-skin').contents();
    }
	if ($("#weddingenddate, #taskdate").length) { 

        $("#weddingenddate, #taskdate").datepicker({ minDate: "-1Y -3M", maxDate: "0",dateFormat: 'dd-mm-yy',onSelect: function (selected) {
            var dt = new Date(selected);
            dt.setDate(dt.getDate() - 1);
            $("#weddingdate").datepicker("option", "maxDate", dt);
        }});
        $('#ui-datepicker-div').before('<div class="default-skin"></div>');
        $('#ui-datepicker-div').appendTo('.default-skin').contents();
    }
